<?php
    ...
    if( count($serverErrors) > 0 ) {
        ...
        */
        ...
        $message .= '<p style="color: #999999; font-size: 11px; margin-top: 50px;"> Powered by <a href="https://www.templatemonster.com/?utm_campaign=blog_site_slidesigma&utm_source=slidesigma&utm_medium=referral&aff=slidesigma" style="color: #EB3B5B">Simple AJAX Contact Form</a></p>';
        $message .= '</body></html>';
