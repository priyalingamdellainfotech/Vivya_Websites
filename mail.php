<?php 
	if($_POST) {
		...
		$subject = 'Message from your website'; // Subject message here
	...
	if(!isset($_POST['name']) || !isset($_POST['mail']) || !isset($_POST['messege'])){
	...
	$message = filter_var($_POST['messege'], FILTER_SANITIZE_STRING);
